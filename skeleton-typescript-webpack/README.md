...
It sets up a standard navigation-style app using webpack to build your TypeScript code with the TypeScript compiler. Karma/Protractor/Jasmine testing is also configured.
